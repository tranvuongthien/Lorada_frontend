...
$(function () {
    const products = [
        {
            ...
            price: "80.00",
            old_price: "90.00",
            color: ["black", "pastel blue", "pink", "blue", "light green", "seinna"],
        ...
        },
        {
            ...
            src: "dist/Final_project/img/1a.jpg",
            src_hover: "dist/Final_project/img/3b.jpg",
            categories: ["face", "eye", "best-seller", "featured", "brush"],
            price: "80.00",
            old_price: "90.00",
            color: ["black", "pastel blue", "pink", "seinna"],
            img: ["dist/Final_project/img/1a.jpg",
                "dist/Final_project/img/1b.jpg",
                "dist/Final_project/img/1c.jpg",
                "dist/Final_project/img/1d.jpg"
            ]
        },
        {
            id: 4,
    ...
    // cài owl-carousel cho box recommend for you
...
function renderOwl2(products, selector) {
    ...
    if (index * 6 < products.length) {
        ...
        products
            ...
            .map((val) => {
                bigitem += ` <div class="item col12-sm-4">
                <div class="small-container-item">
                    <div class="wrap-img-item">
